...
const Chatbot = () => {
      ...
      history: [
        {
          role: "user",
          parts: [
            {text: "ask everytime which langauage to proceed in hindi or english and give the further response in the choosen language only and you are farmer's chatbot give responses related to farming only ."},
          ],
        },
        {
          role: "model",
          parts: [
            {text: "आप किस भाषा में बात करना चाहते हैं, हिंदी या अंग्रेजी? / Which language would you like to proceed in, Hindi or English? \n"},
          ],
        },
      ],
    });
  ...
  return (
    <div className=" min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
      <div className="absolute top-32 bg-red-500 rounded-lg shadow-lg p-6 m-10 max-w-4xl w-auto md:w-full sm:max-w-2xl sm:w-full">
